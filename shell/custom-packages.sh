...
# 排除 DiskMan 和 TTYD
CUSTOM_PACKAGES="$CUSTOM_PACKAGES -luci-i18n-diskman-zh-cn -luci-i18n-ttyd-zh-cn"
...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-ddns-go-zh-cn"  # 已启用
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-ddns-zh-cn"
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-diskman-zh-cn"  # 已排除
...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-ttyd-zh-cn"  # 已排除
...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-zerotier-zh-cn"  # 已启用
